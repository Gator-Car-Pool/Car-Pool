...
//  Car Pool
//
//  Created by Brandon Tran on 12/4/21.
//
    ...
    var body: some View {
        TimelineView(.animation) { timeline in
            Canvas { context, size in
                ...
                context.fill(path, with: .linearGradient(Gradient(colors: [.blue, .green, .orange]), startPoint: .init(x: 0, y: 0), endPoint: .init(x: 400, y: 400)))
            }
        }
